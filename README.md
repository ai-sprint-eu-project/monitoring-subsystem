...
### setup monitoring
```sh
kubectl cp monitoring.yaml $MM_POD_NAME:templates/monitoring_setup.yaml
kubectl exec $MM_POD_NAME -- ./setup_monitoring.sh
```

### setup app
```sh
kubectl cp qos_consraints.yaml $MM_POD_NAME:templates/qos_constraints.yaml
kubectl exec $MM_POD_NAME -- ./setup_app.sh
```

### setup app custom
```sh
kubectl cp custom.yaml $MM_POD_NAME:templates/custom_setup.yaml
kubectl exec $MM_POD_NAME -- ./setup_app_custom.sh
```

### remove app
```sh
kubectl exec $MM_POD_NAME -- ./remove_app.sh
```
